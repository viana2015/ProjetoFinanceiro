...
import com.jrcg.jrmoney.api.exceptionhandler.JrmoneyExceptionHandler.Erro;
...
import com.jrcg.jrmoney.api.service.LancamentoService;
...
public class LancamentoResource {
	...
	//Exceção de lançamentos
	@ExceptionHandler( {PessoaInexistenteOuInativaException.class})
	public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex){
		String mensagemUsusario =  messageSource.getMessage("pessoa.inexistente-ou-inativa", null, LocaleContextHolder.getLocale());
